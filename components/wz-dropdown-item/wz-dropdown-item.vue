<template>
	<view class="u-dropdown-item" v-if="active" @touchmove.stop.prevent="() => {}" @tap.stop.prevent="() => {}">
			<scroll-view scroll-y="true" style="height: 600rpx;box-shadow: 10px 10px 5px #888888;">
	...
	export default {
		...
		data() {
			return {
				...
				activeColor: '#ef5e3c', // 激活时左边文字和右边对勾图标的颜色
